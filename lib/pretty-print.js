...
//
// Design by Contract: Documents expected input/output and asserts preconditions.

/**
 * Pretty-prints a GraphQL response object.
 * @param {object} res - Response object
 * @param {object} [opts] - Options (e.g., raw)
 */
function prettyPrintResponse(res, opts = {}) {
  if (typeof res !== "object" || res === null) {
    throw new Error("prettyPrintResponse: res must be an object");
  }
